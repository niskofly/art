        ...
        <? if ($arSection['DESCRIPTION'] && strpos($_SERVER['REQUEST_URI'], 'PAGEN') === false): ?>
          ...
          <ul class="anchor-list">
            <li class="anchor-list__item">
              <a class="anchor-list__item-link" href="#desc">Об услуге</a>
            </li>
            <li class="anchor-list__item">
              <a class="anchor-list__item-link" href="#price-block">Цены</a>
            </li>
            <li class="anchor-list__item">
              <a class="anchor-list__item-link" href="#specialists">Специалисты</a>
            </li>
            ...
            <? if (count($arResult['DISPLAY_PROPERTIES']['LINK_REVIEWS']['VALUE']) > 0) { ?>
              <li class="anchor-list__item">
