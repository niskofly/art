...
if ($arResult['NavPageCount'] > 1 || $arResult['NavShowAlways']) {
	...
	$arPages['first'] = [
		...
		'label' => '<svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#anglePrev"></use></svg><svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#anglePrev"></use></svg>',
		'num' => FIRST_PAGE_NUM,
	...
	$arPages['previous'] = [
		...
		'label' => '<svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#anglePrev"></use></svg>',
	...
	$arPages['next'] = [
		...
		'label' => '<svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#angleNext"></use></svg>',
		'num' => $currentPageNum + 1,
		'url' => $uri->addParams(['PAGEN_' . $arResult["NavNum"] => $currentPageNum + 1])->getUri(),
		'class' => [],
	];
	$arPages['last'] = [
		...
		'label' => '<svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#angleNext"></use></svg><svg><use xlink:href="' . SITE_TEMPLATE_PATH . '/sprite.svg#angleNext"></use></svg>',
		'num' => $lastPageNum,
