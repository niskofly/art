...
$this->addExternalCss(SITE_TEMPLATE_PATH . '/vendors/fancybox-master/dist/jquery.fancybox.css');

$this->addExternalJs(SITE_TEMPLATE_PATH . '/vendors/OwlCarousel2-2.3.4/dist/owl.carousel.js');
$this->addExternalJs(SITE_TEMPLATE_PATH . '/vendors/fancybox-master/dist/jquery.fancybox.js');
?>


<div class="licenses owl-container" id="<?= $slider_id ?>">
	<div class="owl-carousel">
		...
		foreach ($arResult["ITEMS"] as $arItem) {
			...
			<div class="slider__item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
				<a class="slider__link" href="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>" data-fancybox="gallery">
