...
$MESS["SOA_ORDER_SUC"]
	= "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно создан.";
...
$MESS["SOA_PAY_LINK"]
	= "Если окно с платежной информацией не открылось автоматически, нажмите на ссылку <a href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a>.";
$MESS["SOA_PAY_PDF"]
	= "Для того, чтобы скачать счет в формате pdf, нажмите на ссылку <a href=\"#LINK#\" target=\"_blank\">Скачать счет</a>.";
...
$MESS["STOF_REG_SMS_REQUEST"]
	= "На ваш номер было выслано СМС с кодом подтверждения";
...
$MESS["SOA_NO_JS"]
	= "Для оформления заказа необходимо включить JavaScript. По-видимому, JavaScript либо не поддерживается браузером, либо отключен. Измените настройки браузера и затем <a href=\"\">повторите попытку</a>.";
...
$MESS["SOA_LOCATION_NOT_FOUND_PROMPT"]
	= "#ANCHOR#Выберите местоположение из списка#ANCHOR_END#, чтобы мы узнали, куда нам доставить ваш заказ";
$MESS["SOA_NOT_SELECTED_ALT"] = "При необходимости уточнить местоположение";
$MESS["SOA_ORDER_PS_ERROR"]
	= "Ошибка выбранного способа оплаты. Обратитесь к Администрации сайта, либо выберите другой способ оплаты.";
