...
<div class="catalog-section">
    <div class="block-bottom catalog-section__filter">
		<?php
    ...
    <div class="catalog-section__content">
        <div class="block catalog-section__main">
			<?php
			// INFO Список разделов
			$sectionListParams = [
				"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
...
//				'PRODUCT_ROW_VARIANTS' => $arParams['LIST_PRODUCT_ROW_VARIANTS'],
			...
			$arSort = []; //INFO формируется в sort.php
			include 'sort.php';
			$intSectionID = $APPLICATION->IncludeComponent(
				componentName: "bitrix:catalog.section",
				componentTemplate: "default",
				arParams: array_merge($arSectionParams, $arSort),
		...
		<?php
		// INFO Рекомендации ?>
        <div class="block catalog-section__recommendations">
			<?php
			$GLOBALS['CATALOG_CURRENT_SECTION_ID'] = $intSectionID;
			if (
				ModuleManager::isModuleInstalled("sale") &&
				!empty($arRecomData) &&
				(!isset($arParams['USE_BIG_DATA']) || $arParams['USE_BIG_DATA'] != 'N')
			) {
				?>
                <div data-entity="parent-container">
                    <div class="catalog-section__recommendations-title" data-entity="header" data-showed="false"
                         style="display: none; opacity: 0;">
                        Персональные рекомендации
                    </div>
					<?php

					$arRecommendationsParams = $arSectionParams;

					$arRecommendationsParamsModify = [
...
//                        'PRODUCT_ROW_VARIANTS' => "[{'VARIANT':'6','BIG_DATA':true}]",
					...
					$oldRecommendationsParams = [
						...
						'OFFERS_SORT_FIELD2' => $arParams['OFFERS_SORT_FIELD2'],
						'OFFERS_SORT_ORDER2' => $arParams['OFFERS_SORT_ORDER2'],
						'OFFERS_LIMIT' => $arParam['LIST_OFFERS_LIMIT'] ?? 0,
...
//							'PRODUCT_ROW_VARIANTS' => $arParams['LIST_PRODUCT_ROW_VARIANTS'],
					...
					$APPLICATION->IncludeComponent(
						...
						"default",
						arParams: array_merge($arRecommendationsParams, $arRecommendationsParamsModify),
						parentComponent: $component,
