...
<div class="promo">
    <div class="promo__list">
	    ...
	    foreach($arResult["ITEMS"] as $arItem)
	    {
		    ...
		    if( $arItem['DISPLAY_PROPERTIES']['COLOR_SCHEME']['VALUE_XML_ID'] )
			    $color_scheme = "tails-t5--".$arItem['DISPLAY_PROPERTIES']['COLOR_SCHEME']['VALUE_XML_ID'];
		    else $color_scheme = "tails-t5--none";
		    ?>
            <div class="promo__item"  id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                <div class="tails-t5 <?=$color_scheme?>">
                    <?php
                    ...
                    ?>
                    <div class="tails-t5__content promo__tail-content" style="background-image: url('<?=$arItem['PREVIEW_PICTURE']['SRC']?>');">
