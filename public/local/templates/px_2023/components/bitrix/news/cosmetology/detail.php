...
if($GLOBALS['EQUIPMENT_BLOCK_ELEMENT_TEXT1']){
	?>
	<div class="equipment-top">
		<?php echo $GLOBALS['EQUIPMENT_BLOCK_ELEMENT_TEXT1'];
...
if ($GLOBALS['TEXT_UPPER_STOCK1']) {
	?>
	<div class="uslugi_additional-text">
		<?
		echo $GLOBALS['TEXT_UPPER_STOCK1'];
...
if ($GLOBALS['LINKS_FOR_EQUIP']){
	...
	if ($GLOBALS['TEXT_UPPER_EQUIP1']) {
		?>
		<div class="uslugi_additional-text">
			<?
			echo $GLOBALS['TEXT_UPPER_EQUIP1'];
...
if ($GLOBALS['LINKS_FOR_STUFF']){
	...
	if ($GLOBALS['TEXT_UPPER_DOCTORS1']) {
		?>
		<div class="uslugi_additional-text">
			<?
			echo $GLOBALS['TEXT_UPPER_DOCTORS1'];
	...
	<div class="container">
		...
		<div class="reviews">
			...
			if($GLOBALS['LINKS_FOR_REVIEWS']){
				...
				if ($GLOBALS['TEXT_UPPER_REVIEWS1']) {
					?>
					<div class="uslugi_additional-text">
						<?
						echo $GLOBALS['TEXT_UPPER_REVIEWS1'];
...
<h2 class="title section-site__title price-title">Косметология Одинцово: цены на услуги</h2>
<?php

if ($GLOBALS['TEXT_UPPER_PRICE1']) {
	?>
	<div class="uslugi_additional-text uslugi_additional-text--price">
		<?
		echo $GLOBALS['TEXT_UPPER_PRICE1'];
...
$GLOBALS['arrFilterHits']=array("PROPERTY_COSMETOLOGY"=> array($GLOBALS['CUR_ELEMENT_ID']));
