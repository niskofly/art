...
if (isset($arParams['USE_COMMON_SETTINGS_BASKET_POPUP']) && $arParams['USE_COMMON_SETTINGS_BASKET_POPUP'] == 'Y') {
	...
	$basketAction = $arParams['DETAIL_ADD_TO_BASKET_ACTION'] ?? [];
}
...
if ($elementId > 0) {
	...
	if (!empty($recommendedData)) {
		if (false) { /* !empty($recommendedData['IBLOCK_LINK']) || !empty($recommendedData['ALL_LINK']) */
			?>
            <div class='block'><?php
				// catalog-element__block--small ?>
                <div class='' data-entity="parent-container">
                    <div class="catalog-block-header" data-entity="header" data-showed="false"
                         style="display: none; opacity: 0;">
						<?= GetMessage('CATALOG_RECOMMENDED_BY_LINK') ?>
                    </div>
                    <h2 class="catalog-section__recommendations-title">Рекомендации</h2>
					<?php
					//pre($recommendedData);
					$APPLICATION->IncludeComponent(
						...
						[
							...
							'IBLOCK_ID' => $arParams['IBLOCK_ID'],
							'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
							'PROPERTY_LINK' => $recommendedData['IBLOCK_LINK'] ?? $recommendedData['ALL_LINK'],
							'CACHE_TYPE' => $arParams['CACHE_TYPE'],
							'CACHE_TIME' => $arParams['CACHE_TIME'],
		...
		if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N') {
			?>
            <div class='block block-border-bottom'><?php
				// catalog-element__block--small ?>
                <div class='' data-entity="parent-container">
                    <div class="catalog-block-header" data-entity="header" data-showed="false"
                         style="display: none; opacity: 0;">
                    ...
                    <h2 class="catalog-section__recommendations-title">Популярные</h2>
					<?php
