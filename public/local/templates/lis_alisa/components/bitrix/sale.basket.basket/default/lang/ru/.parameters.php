...
$MESS["CP_SBB_TPL_COLUMNS_LIST_MOBILE"]
	= "Колонки, отображаемые на мобильных устройствах";
$MESS["CP_SBB_TPL_PROPERTIES_RECALCULATE_BASKET"]
	= "Свойства, влияющие на пересчет корзины";
$MESS["CP_SBB_TPL_THEME_SITE"]
...
$MESS["CP_SBB_TPL_DEFERRED_REFRESH"]
...
$MESS["CP_SBB_EMPTY_BASKET_HINT_PATH"]
	= "Путь к странице для продолжения покупок";
$MESS["CP_SBB_TPL_TOTAL_BLOCK_DISPLAY"]
...
$MESS["CP_SBB_TPL_USE_DYNAMIC_SCROLL"]
...
$MESS["CP_SBB_TPL_USE_ENHANCED_ECOMMERCE"]
...
$MESS["EMPTY_BASKET_HINT_PATH_TIP"]
	= "Ссылка для продолжения покупок отображается в случае если корзина пуста.<br>При условии, что путь пустой, текст не будет отображен.";
