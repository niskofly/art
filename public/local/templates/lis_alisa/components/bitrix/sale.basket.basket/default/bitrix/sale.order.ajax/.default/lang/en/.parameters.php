...
$MESS["AUTH_REFERENCE_2_DEFAULT"]
	= "You will receive the notification message upon completing the registration.";
$MESS["AUTH_REFERENCE_3"] = "Hint #3 for \"Authentication\" block";
$MESS["AUTH_REFERENCE_3_DEFAULT"]
	= "Your personal information acquired upon registration, placing of an order, or by any other means will never be rented, sold or transferred to third parties unless required by legal authorities or court decision..";
...
$MESS["DELIVERY_CALC_ERROR_TEXT_DEFAULT"]
	= "Continue checkout. Our sales representative will contact you with delivery details.";
...
$MESS["DELIVERY_FADE_EXTRA_SERVICES"]
	= "Show selected extra services in a hidden block";
...
$MESS["FAIL_PRELOAD_TEXT"]
	= "Notification text to display on order data load failure";
...
$MESS["PAY_SYSTEM_PAYABLE_ERROR_DEFAULT"]
	= "You'll be able to pay for the order after we verify that the items you have ordered are in stock. Once your order is fulfilled, you'll receive an email with payment instructions. You'll be able to complete the purchase inside your customer account.";
$MESS["PAY_SYSTEM_PAYABLE_ERROR_TEXT"]
	= "Notification text to show when order cannot be paid";
...
$MESS["PRODUCT_COLUMNS_HIDDEN"]
	= "Additional hidden columns in order products table";
...
$MESS["REGION_REFERENCE_DEFAULT"]
	= "Select your city from the list. If you cannot find your city, select \"other location\" and enter your city in the \"City\" field.";
$MESS["REGISTRATION_REFERENCE"] = "Open registration page text";
$MESS["REGISTRATION_REFERENCE_DEFAULT"]
	= "Please register for better shopping experience and to keep your order history.";
...
$MESS["SERVICES_IMAGES_SCALING_TIP"]
	= "This also affects logos of payment and delivery systems, and pick-up locations.";
...
$MESS["SHOW_COUPONS_PAY_SYSTEM"]
	= "Show coupon code input field in payment block";
...
$MESS["SHOW_PAY_SYSTEM_INFO_NAME"]
	= "Show payment system name in the information block";
...
$MESS["SHOW_STORES_IMAGES"]
	= "Show warehouse images in pick-up point selection form";
...
$MESS["SUCCESS_PRELOAD_TEXT"]
	= "Notification text to display on order data load success";
...
$MESS["USE_ENHANCED_ECOMMERCE_TIP"]
	= "This requires Google Analytics Enhanced Ecommerce options to be configured";
$MESS["USE_YM_GOALS1"] = "Use Yandex.Metrics counter targets";
$MESS["USE_YM_GOALS_TIP"]
	= "This requires that a Yandex.Metrics counter is on the page.";
...
$MESS["YM_GOALS_NEXT_BASKET"]
	= "Goal ID for transfer from shopping cart to 'Next' button";
$MESS["YM_GOALS_NEXT_DELIVERY"]
	= "Goal ID for transfer from delivery to 'Next' button";
$MESS["YM_GOALS_NEXT_PAY_SYSTEM"]
	= "Goal ID for transfer from payment to 'Next' button";
$MESS["YM_GOALS_NEXT_PICKUP"]
	= "Goal ID for transfer from pick-up locations to 'Next' button";
$MESS["YM_GOALS_NEXT_PROPERTIES"]
	= "Goal ID for transfer from product properties to 'Next' button";
$MESS["YM_GOALS_NEXT_REGION"]
	= "Goal ID for transfer from delivery area to 'Next' button";
