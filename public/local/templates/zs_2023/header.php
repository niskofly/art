				...
				<div class="site-header">
					...
					<div class="site-header__callback">
						<button type="button" class="button button-icon">
							<svg class="icon">
								<use xlink:href="<?= SITE_TEMPLATE_PATH ?>/assets/icons/sprite.svg#phoneCall"></use>
							</svg>
						...
						if (!$userAuth) {
							...
							<div class="user-header__guest">
								<a href="#" class="button-border--icon">
									<svg>
										<use xlink:href="<?= SITE_TEMPLATE_PATH ?>/assets/icons/sprite.svg#logIn"></use>
									</svg>
									<span>Войти</span>
								</a>
							</div>
							...
							<div class="user-header__guest">
								<a href="#" class="button-border--icon">
									<svg>
										<use xlink:href="<?= SITE_TEMPLATE_PATH ?>/assets/icons/sprite.svg#logOut"></use>
									</svg>
									<span>Выйти</span>
								</a>
							</div>
