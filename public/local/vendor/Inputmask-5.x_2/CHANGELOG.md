...
- <strong>remove phone alias</strong> (~ use https://github.com/RobinHerbots/inputmask.phone
  or https://github.com/andr-04/inputmask-multi instead) #1981
...
- commonjs dep to inputmask.dependencyLib instead to inputmask.dependencyLib.jquery => can be symlinked to another
  dependencyLib
...
- replaced radixFocus option by positionCaretOnClick. Allows choice for behavior of the caret on click. (none, lvp (
  default), radixFocus)
- performance updates
	- getmasklength
...
- Browserify
  error: `Error: Cannot find module 'inputmask' from '/Users/.../node_modules/jquery.inputmask/dist/inputmask` #1030
