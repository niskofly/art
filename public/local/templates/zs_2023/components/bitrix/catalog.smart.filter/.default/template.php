...
if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>">
	<div class="bx-filter-section container-fluid">
		...
		echo $arResult["FORM_ACTION"] ?>"
			...
			?>
			<div class="form-body form-body--horizontal">
				<?
					...
					if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>bx-active<?
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							<div class="row bx-filter-parameters-box-container">
								...
								?>
									<div class="form-group form-check bx-filter-param-btn-inline">
										<?php
										foreach ($arItem["VALUES"] as $val => $ar) {
											...
											<label for="<?= $ar["CONTROL_ID"] ?>"
												   ...
												   onclick="smartFilter.keyup(BX('<?= CUtil::JSEscape(
                                                    ...
                                                    <span
														class="form-group__check-label bx-filter-param-btn bx-color-sl">
                                                        <?
								...
								?>
									<div class="form-group form-check">
										...
										foreach ($arItem["VALUES"] as $val => $ar):?>
											...
											?>
											<label class="form-group__check-label" for="<?= $ar["CONTROL_ID"] ?>"
												   data-role="label_<?= $ar["CONTROL_ID"] ?>"
												   class="bx-filter-param-label<?= $class ?>"
												   onclick="smartFilter.keyup(BX('<?= CUtil::JSEscape(
													   $ar["CONTROL_ID"]
								...
								foreach ($arItem["VALUES"] as $val => $ar): ?>
									<div class="form-group form-check  checkbox">
										...
										<label
											data-role="label_<?= $ar["CONTROL_ID"] ?>"
											class="form-group__check-label bx-filter-param-label <?
											echo $ar["DISABLED"] ? 'disabled' : '' ?>"
											for="<?
											echo $ar["CONTROL_ID"] ?>"
										>
