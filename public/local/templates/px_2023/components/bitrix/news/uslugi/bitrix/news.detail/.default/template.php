...
$GLOBALS['TEXT_UPPER_STOCK'] = $arResult['PROPERTIES']['TEXT_UPPER_STOCK']['VALUE']['TEXT'];

$GLOBALS['TEXT_UPPER_EQUIP'] = $arResult['PROPERTIES']['TEXT_UPPER_EQUIP']['VALUE']['TEXT'];

$GLOBALS['TEXT_UPPER_DOCTORS'] = $arResult['PROPERTIES']['TEXT_UPPER_DOCTORS']['VALUE']['TEXT'];

$GLOBALS['TEXT_UPPER_REVIEWS'] = $arResult['PROPERTIES']['TEXT_UPPER_REVIEWS']['VALUE']['TEXT'];

$GLOBALS['TEXT_UPPER_PRICE'] = $arResult['PROPERTIES']['TEXT_UPPER_PRICE']['VALUE']['TEXT'];

$GLOBALS['EQUIPMENT_BLOCK_ELEMENT_TEXT'] = $arResult['PROPERTIES']['EQUIPMENT_BLOCK_ELEMENT_TEXT']['~VALUE']['TEXT'];
...
$arADV = $arResult['PROPERTIES']['ADVANTAGES_ELEMENT']['~VALUE']['TEXT'];
