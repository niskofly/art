...
$user = ["ORDER_DATA", "FIO", "PHONE", "EMAIL", "USER_DESCRIPTION", "ADDRESS"];
?>
...
<p style="margin-top: 0; line-height: 20px;font-size: 13px; font-width: normal;">
	Ваш предзаказ номер № <?= $arParams["ORDER_ID_NEW"] ?> от <?= $arResult["ITEMS"]["ORDER_DATA"]['VALUE'] ?>
	принят.<br>
	<br>
	Подробная информация о предзаказе № <?= $arParams["ORDER_ID_NEW"] ?>
</p>
