...
$arrADV = $flSections['UF_ADVANTAGES_ST'];
...
<div class="uslugi-top__wrapper">
	...
	<div class="uslugi-top__top">
		...
		if($flSections['UF_BLOCK_EQUIP']){
			?>
			<div class="equipment-top">
				<?php echo $flSections['UF_BLOCK_EQUIP'];

				global $arrFilterEquipment;

				$GLOBALS['arrFilterEquipment'] = array("ID" => $flSections['UF_LINK_EQUIPMENT']);

				if ($flSections['UF_LINK_EQUIPMENT']){
					?>
...
if ($flSections['UF_STOCK_TEXT']) {
	?>
	<div class="uslugi_additional-text">
		<?
		echo $flSections['UF_STOCK_TEXT'];
...
if ($flSections['UF_LINK_EQUIPMENT']) {
	...
	<h2 class="title section-site__title">Оборудование</h2>
		<?php
	if ($flSections['UF_EQUIP_TEXT']) {
		?>
		<div class="uslugi_additional-text">
			<?
			echo $flSections['UF_EQUIP_TEXT'];
...
$GLOBALS['arrFilterDocs'] = array("ID" => $flSections['UF_LINK_STAFF']);


if ($flSections['UF_LINK_STAFF']) {
	...
	if ($flSections['UF_DOCTORS_TEXT']) {
		?>
		<div class="uslugi_additional-text">
			<?
			echo $flSections['UF_DOCTORS_TEXT'];
...
<section class="section-site">
	<div class="container">
		...
		<div class="reviews">
			...
			$GLOBALS['arrFilterReviews'] = array("ID" => $flSections['UF_LINK_REVIEWS']);

			if ($flSections['UF_LINK_REVIEWS']) {

				?>
				<h2 class="title section-site__title">Отзывы</h2>
				<?php

				if ($flSections['UF_REVIEWS_TEXT']) {
					?>
					<div class="uslugi_additional-text">
						<?
						echo $flSections['UF_REVIEWS_TEXT'];
...
if ($flSections['UF_TEXT_UPPER__SECTION_PRICE']) {
	?>
	<div class="uslugi_additional-text uslugi_additional-text--price">
		<?
		echo $flSections['UF_TEXT_UPPER__SECTION_PRICE'];
...
$GLOBALS['arrFilterHits']=array("PROPERTY_SERVICES_SECTIONS"=> array($arSection['ID']));
...
<?php
if($flSections['UF_LINK_QUESTIONS']){

	$GLOBALS['arrFilterVoprosy'] = array("ID" => $flSections['UF_LINK_QUESTIONS']);
?>
