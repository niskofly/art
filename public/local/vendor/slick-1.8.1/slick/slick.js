		...
		if (_.options.centerMode === true) {
			...
			if (_.options.infinite === true) {
				...
				if (index >= centerOffset && index <= (_.slideCount - 1) -
						centerOffset) {
					_.$slides.slice(index - centerOffset + evenCoef,
					...
					allSlides.slice(indexOffset - centerOffset + 1 + evenCoef,
			...
			if (index >= 0 && index <= (_.slideCount - _.options.slidesToShow)) {
				...
				if (_.options.slidesToShow == _.options.slidesToScroll &&
					...
					allSlides.slice(indexOffset - (_.options.slidesToShow - remainder),
