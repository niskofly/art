...
?>
<div class="prices_back-call">
	<div class="prices_back-call__left">
		<div class="prices_back-call_img">
			<img class="load" loading="lazy" src="<?=$arParams['IMG']?>"
					 alt="back-call">
		</div>


		<div class="prices_back-call_text">
			<span class="prices_back-call_text-title"><?=$arParams['TITLE']?></span>
			<a class="prices_back-call_text-call" href="tel:<?=$phone_clear?>">
				<img class="load" loading="lazy" data-src="/include/index-blocks/img/prices_back-call/call.svg"
						 alt="call">
				<span><?=$phone_src?></span>
			</a>
			<p class="prices_back-call_text-descr">
				<?php
