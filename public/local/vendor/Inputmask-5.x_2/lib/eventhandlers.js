...
var EventHandlers = {
					...
					setTimeout(function () {
						...
						if (inputmask.isRTL) {
							caret.call(
								...
								input,
								caretPos.begin +
									(caretPos.begin === maskset.maskLength ? 0 : 1),
							);
						} else {
							caret.call(
								inputmask,
	...
	keypressEvent: function (e, checkval, writeOut, strict, ndx) {
		...
		if (
			...
			if ((k === 44 || k === 46) && e.location === 3 && opts.radixPoint !== "")
	...
	keyupEvent: function (e) {
		...
		if (
			...
			(e.keyCode === keyCode.KEY_229 || e.keyCode === keyCode.ENTER)
		) {
	...
	mouseenterEvent: function () {
		...
		if (
			...
			if (
				...
				input.placeholder !== inputmask.originalPlaceholder
			) {
