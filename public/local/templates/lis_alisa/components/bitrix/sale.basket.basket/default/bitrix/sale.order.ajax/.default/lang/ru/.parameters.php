...
$MESS["PRODUCT_COLUMNS_HIDDEN"]
	= "Свойства товаров отображаемые в свернутом виде в списке товаров";
$MESS["SHOW_MAP_FOR_DELIVERIES"]
	= "Показывать карту для выбранных служб доставки";
$MESS["PROPS_FADE_LIST"]
	= "Свойства заказа, которые будут показаны в пройденном (свернутом) блоке";
$MESS["USE_CUSTOM_MESSAGES"] = "Заменить стандартные фразы на свои";
$MESS["USE_YM_GOALS1"] = "Использовать цели счетчика Яндекс.Метрики";
$MESS["USE_YM_GOALS_TIP"]
	= "Счетчик Яндекс.Метрики должен быть подключен на странице";
$MESS["YM_GOALS_COUNTER"] = "Номер счётчика Яндекс.Метрика";
$MESS["YM_GOALS_INITIALIZE"]
	= "Идентификатор цели при инициализации компонента на странице";
$MESS["YM_GOALS_EDIT_REGION"]
	= "Идентификатор цели при редактировании блока региона доставки";
$MESS["YM_GOALS_EDIT_DELIVERY"]
	= "Идентификатор цели при редактировании блока доставки";
$MESS["YM_GOALS_EDIT_PICKUP"]
	= "Идентификатор цели при редактировании блока пунктов самовывоза";
$MESS["YM_GOALS_EDIT_PAY_SYSTEM"]
	= "Идентификатор цели при редактировании блока оплаты";
$MESS["YM_GOALS_EDIT_PROPERTIES"]
	= "Идентификатор цели при редактировании блока свойств заказа";
$MESS["YM_GOALS_EDIT_BASKET"]
	= "Идентификатор цели при редактировании блока списка товаров";
$MESS["YM_GOALS_NEXT_REGION"]
	= "Идентификатор цели при переходе из блока региона доставки по кнопке \"Далее\"";
$MESS["YM_GOALS_NEXT_DELIVERY"]
	= "Идентификатор цели при переходе из блока доставки по кнопке \"Далее\"";
$MESS["YM_GOALS_NEXT_PICKUP"]
	= "Идентификатор цели при переходе из блока пунктов самовывоза по кнопке \"Далее\"";
$MESS["YM_GOALS_NEXT_PAY_SYSTEM"]
	= "Идентификатор цели при переходе из блока оплаты по кнопке \"Далее\"";
$MESS["YM_GOALS_NEXT_PROPERTIES"]
	= "Идентификатор цели при переходе из блока свойств заказа по кнопке \"Далее\"";
$MESS["YM_GOALS_NEXT_BASKET"]
	= "Идентификатор цели при переходе из блока списка товаров по кнопке \"Далее\"";
...
$MESS["REGISTRATION_REFERENCE_DEFAULT"]
	= "Если вы впервые на сайте, и хотите, чтобы мы вас помнили и все ваши заказы сохранялись, заполните регистрационную форму.";
$MESS["AUTH_REFERENCE_1"] = "Справочная информация №1 блока \"Авторизация\"";
$MESS["AUTH_REFERENCE_1_DEFAULT"]
...
$MESS["SUCCESS_PRELOAD_TEXT"]
	= "Текст уведомления о корректной загрузке данных заказа";
...
$MESS["FAIL_PRELOAD_TEXT"]
	= "Текст уведомления о неудачной загрузке данных заказа";
...
$MESS["PAY_SYSTEM_PAYABLE_ERROR_TEXT"]
	= "Текст уведомления при статусе заказа, недоступном для оплаты";
$MESS["PAY_SYSTEM_PAYABLE_ERROR_DEFAULT"]
	= "Вы сможете оплатить заказ после того, как менеджер проверит наличие полного комплекта товаров на складе. Сразу после проверки вы получите письмо с инструкциями по оплате. Оплатить заказ можно будет в персональном разделе сайта.";
?>
