...
<div class="registry-members ajax-filter">
        ...
        <form class="registry-members__properties table table__list ajax-filter__options">
			...
			if( $arResult["FILTER"] )
			{
                ...
                <div class="block_filter table__row">
					...
					?>
                    <div class="table__col filter__item registry-members__fullname table__col--<?= strtolower( $f_name )?> block_filter__item ">
                        <div class="switcher"  >
					...
					$filter = $arResult["FILTER"][$f_name];
					?>
                    <div class="table__col filter__item registry-members__regnumber table__col--<?=strtolower( $f_name )?> block_filter__item ">
                        <label class="block_filter__name" for="<?=$f_name?>"><?=$filter["NAME"]?></label>
                        <div class="block_filter__select">
                            <input type="text" name="%PROPERTY_<?=$f_name?>" id="<?=$f_name?>">
                        </div>
    ...
    <div class="registry-members__list table__list ajax-filter__results" id="filter-result">
		...
		foreach( $arResult["ITEMS"] as $arItem )
		{
			...
			?>
            <div class="registry-members__item zebra__item table__row" id="<?=$this->GetEditAreaId( $arItem['ID'] )?>" data-entity="items-row">
                ...
                <div class="registry-members__regnumber table__col">
                    <a class="registry-members__value <?=$arItem['PROPERTIES']['GROUP1_REGISTRATION_NUMBER']['VALUE'] ? "registry-members__value--title" : ""?>" href="<?=$arItem['DETAIL_PAGE_URL']?>">
